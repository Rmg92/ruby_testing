...
describe FindNumber do
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      let(:final_number) { double('final_number', value: 4) }
      subject(:game_solution) { described_class.new(0, 9, final_number, 4) }
    ...
    context 'when guess and random_number are not equal' do
      let(:final_number) { double('final_number', value: 4) }
      subject(:game_continues) { described_class.new(0, 9, final_number, 5) }
